...
def make_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    if model_opt.encoder_type == "trigramrnn" and model_opt.decoder_type == "rnn":
        ...
        if model_opt.encoder_type == "brnn" and model_opt.decoder_type == "charrnn":
            model = NMTTargetCharModel(encoder, decoder1, decoder2)
        else:
            if model_opt.encoder_type == "trigramrnn" and model_opt.decoder_type == "charrnn":
                model = CharNMTModel(encoder, decoder)
            else:
